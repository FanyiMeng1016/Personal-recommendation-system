...
# Function to extract features from an image using the ResNet152 model
...
pickle.dump(image_features, open("image_features_embedding_101.pkl", "wb"))
pickle.dump(img_files, open("img_files_101.pkl", "wb"))
